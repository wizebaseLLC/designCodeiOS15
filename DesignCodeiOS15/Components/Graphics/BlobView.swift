...
struct BlobView: View {
    ...
    func path(in rect: CGRect, x: Double, x2: Double) -> Path {
        ...
        path.addCurve(to: CGPoint(x: 0.6355*width, y: height), control1: CGPoint(x: 0.92554*width, y: 0.77749*height), control2: CGPoint(x: 0.91864*width, y: height * x2))
        ...
        path.addCurve(to: CGPoint(x: 0.34086*width, y: 0.06324*height * x), control1: CGPoint(x: -0.0896*width, y: 0.43038*height * x), control2: CGPoint(x: 0.00248*width, y: 0.23012*height * x))
